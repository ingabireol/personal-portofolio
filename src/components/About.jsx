...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-10" id="about">
        ...
        <div className="w-full flex items-center justify-between md:justify-center">
            <Image src={'/Assets/about-me.png'}
                ...
                />
            <div className="relative max-w-[800px]  bg-zinc-100 rounded-xl p-5 text-justify dark:bg-zinc-700 transition-colors">
                <span className="absolute -left-6 top-36 text-2xl scale-[2.5] text-zinc-100">{arrowLeftIcon}</span>
                <p className="text-lg font-light text-gray-700 first-letter:pl-3 lg:text[16px] sm:text-[14px] dark:text-gray-200 transition-colors">{aboutText}</p>
